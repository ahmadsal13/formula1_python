...
year, grand_prix, session = 2022, 'Silverstone', 'Q'

quali = ff1.get_session(year, grand_prix, session)
quali.load()

# These are the drivers I will be using Lewis and Perez
driver_1, driver_2 = 'HAM', 'PER'

# This is the laps object made for the current racing session
...
# Selecting different team name for the coloring to be able to tell which driver is which
...
# RPM trace
ax[5].plot(telemetry_driver_1['Distance'], telemetry_driver_1['RPM'],
           label=driver_1, color=ff1.plotting.team_color(team_driver_1))
ax[5].plot(telemetry_driver_2['Distance'], telemetry_driver_2['RPM'],
           label=driver_2, color=ff1.plotting.team_color(team_driver_2))
ax[5].set(ylabel='RPM')

# DRS trace
ax[6].plot(telemetry_driver_1['Distance'], telemetry_driver_1['DRS'],
           label=driver_1, color=ff1.plotting.team_color(team_driver_1))
ax[6].plot(telemetry_driver_2['Distance'], telemetry_driver_2['DRS'],
           label=driver_2, color=ff1.plotting.team_color(team_driver_2))
ax[6].set(ylabel='DRS')
